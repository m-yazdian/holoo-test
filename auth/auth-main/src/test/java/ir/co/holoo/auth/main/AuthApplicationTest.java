...
class AuthApplicationTest {
    ...
    @Test
    @DisplayName("Testing AuthApplication main method.")
    void hasApplicationContextIsOfTypeServletWebServerApplicationContextWhenApplicationStarts() {
        mockedStatic
                .when((MockedStatic.Verification) SpringApplication.run(AuthApplication.class))
                .thenReturn(applicationContext);
        AuthApplication.main(new String[]{});
        assertThat(SpringApplication.run(AuthApplication.class)).isEqualTo(applicationContext);
    }
}
